...
public class Projectile : MonoBehaviour, IProjectile
{
    ...
    private void Start()
    {
        distanceTilDie = GameManager.Instance.CurrentInGameState == GameplayState.PVE? CONSTANT_VALUE.FIRST_CIRCLE_RADIUS + CONSTANT_VALUE.OFFSET_DISTANCE : CONSTANT_VALUE.ZC_FIRST_CIRCLE_RADIUS + CONSTANT_VALUE.OFFSET_DISTANCE;
